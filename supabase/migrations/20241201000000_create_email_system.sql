...
CREATE INDEX IF NOT EXISTS idx_email_records_recipient_email ON email_records(recipient_email);
...
CREATE INDEX IF NOT EXISTS idx_email_records_sent_at ON email_records(sent_at DESC);
CREATE INDEX IF NOT EXISTS idx_email_records_campaign_name ON email_records(campaign_name);
...
COMMENT ON TABLE email_records IS 'Stores records of all emails sent through the system';
COMMENT ON TABLE email_templates IS 'Stores email templates for different campaigns';
COMMENT ON COLUMN email_records.recipient_email IS 'Email address of the recipient';
COMMENT ON COLUMN email_records.template_name IS 'Human-readable name of the template used';
COMMENT ON COLUMN email_records.template_id IS 'Unique identifier of the template used';
COMMENT ON COLUMN email_records.status IS 'Status of email delivery: sent or failed';
COMMENT ON COLUMN email_records.campaign_name IS 'Name of the campaign this email belongs to';
COMMENT ON COLUMN email_templates.category IS 'Category of template: Onboarding, Sales, Nurture, etc.';
COMMENT ON COLUMN email_templates.is_active IS 'Whether this template is available for use';
